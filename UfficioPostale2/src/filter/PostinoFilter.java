...
/**
 * Servlet Filter implementation class PostinoFilter
 */
@WebFilter("/PostinoFilter")
public class PostinoFilter implements Filter {
	FilterConfig filterConfig;
    /**
     * Default constructor. 
     */
    public PostinoFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(!((DipendentiBean)dip).getTipo().equals("postino")){
